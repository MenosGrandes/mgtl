...
template<std::size_t NUMBER_OF_BITS, typename _memory_t> struct bite_size_base
{
  ...
  constexpr static size_type memory_size_whole_v = static_cast<memory_t>(NUMBER_OF_BITS / memory_t_digits);
  ...
  : public bite_size_base<NUMBER_OF_BITS, _memory_t>
{
  ...
  constexpr static size_type memory_size_rounded_up_v = memory_size_whole_v + 1;
};
/*
