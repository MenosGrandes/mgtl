...
// configuration step. It creates a namespace called `mgtl`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", mgtl::cmake::project_name, mgtl::cmake::project_version) };
