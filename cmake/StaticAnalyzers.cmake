macro(mgtl_enable_cppcheck WARNINGS_AS_ERRORS CPPCHECK_OPTIONS)
...
macro(mgtl_enable_clang_tidy target WARNINGS_AS_ERRORS)
  ...
  if(CLANGTIDY)
    ...
    message(STATUS "Enable clan-tidy: ${CLANGTIDY}")
    set(CMAKE_CXX_CLANG_TIDY ${CLANG_TIDY_OPTIONS})
  else()
    message(STATUS ${WARNING_MESSAGE} "clang-tidy requested but executable not found")
  endif()
endmacro()
